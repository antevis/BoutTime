...
struct HistoryModel {
	...
	let events: [HistoryEvent]? =
		[
			...
			HistoryEvent(queueIndex: 4, event: "Ardipithecus kadabba", hint: "5.8 - 5.2 Ma", infoUrl: "http://humanorigins.si.edu/evidence/human-fossils/species/ardipithecus-kadabba"),
			...
			HistoryEvent(queueIndex: 7, event: "Australopithecus afarensis", hint: "3.85 - 2.95 Ma", infoUrl: "http://humanorigins.si.edu/evidence/human-fossils/species/australopithecus-afarensis"),
			HistoryEvent(queueIndex: 8, event: "Kenyanthropus platyops", hint: "3.5 Ma", infoUrl: "http://humanorigins.si.edu/evidence/human-fossils/species/kenyanthropus-platyops"),
			HistoryEvent(queueIndex: 9, event: "Australopithecus bahrelghazali", hint: "3.5 - 3.0 Ma", infoUrl: "https://en.wikipedia.org/wiki/Australopithecus_bahrelghazali"),
			HistoryEvent(queueIndex: 10, event: "Australopithecus africanus", hint: "3.2 - 2.1 Ma", infoUrl: "http://humanorigins.si.edu/evidence/human-fossils/species/australopithecus-africanus"),
			...
			HistoryEvent(queueIndex: 12, event: "Australopithecus garhi", hint: "2.5 Ma", infoUrl: "http://humanorigins.si.edu/evidence/human-fossils/species/australopithecus-garhi"),
			HistoryEvent(queueIndex: 13, event: "Homo habilis", hint: "2.4 - 1.4 Ma", infoUrl: "http://humanorigins.si.edu/evidence/human-fossils/species/homo-habilis"),
			HistoryEvent(queueIndex: 14, event: "Paranthropus boisei", hint: "2.3 - 1.2 Ma", infoUrl: "http://humanorigins.si.edu/evidence/human-fossils/species/paranthropus-boisei"),
			HistoryEvent(queueIndex: 15, event: "Australopithecus sediba", hint: "1.977 - 1.98 Ma", infoUrl: "http://humanorigins.si.edu/evidence/human-fossils/species/australopithecus-sediba"),
			HistoryEvent(queueIndex: 16, event: "Homo rudolfensis", hint: "1.9 - 1.8 Ma", infoUrl: "http://humanorigins.si.edu/evidence/human-fossils/species/homo-rudolfensis"),
			HistoryEvent(queueIndex: 17, event: "Homo ergaster", hint: "1.9 - 1.3 Ma", infoUrl: "https://en.wikipedia.org/wiki/Homo_ergaster"),
			HistoryEvent(queueIndex: 18, event: "Homo erectus", hint: "1.89 - 0.143 Ma", infoUrl: "http://humanorigins.si.edu/evidence/human-fossils/species/homo-erectus"),
